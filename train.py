...
from models.deep.convtasnet_sep import ConvTasNet_SEP
...
if __name__ == "__main__":
    ...
    if train_config['model_type'] == 'cnn':
    ...
    elif train_config['model_type'] == 'convtasnet':
        model = ConvTasNet_SEP(in_channels=n_mic, out_channels=n_source, seq_len=seq_len).to(DEVICE)
        ...
        raise ValueError(f"不支持的模型类型：{train_config['model_type']}，可选cnn/convtasnet/mlp/tcn")
